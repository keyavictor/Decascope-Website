...
<html lang="en">
<head>
<title>Decascope | Your Ideal Partner in General Supplies</title>
<?php
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner" style="height: 400px;">
                      <div class="carousel-item active">
                        <img class="d-block w-100" src="./assets/images/carousel/supply-1.png" alt="First slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="hero-desc"></h1>
                            <p>...</p>
                          </div>  
                    </div>
                      <div class="carousel-item">
                        <img class="d-block w-100" src="./assets/images/carousel/supply-1.png"alt="Second slide">
                        <div class="carousel-caption d-none d-md-block">
                            <h1 class="hero-desc"></h1>
                            <p>...</p>
                          </div>  
                      ...
                      <div class="carousel-item">
                        <img class="d-block w-100" src="./assets/images/carousel/supply-1.png" alt="Third slide">
                      </div>
                      <div class="carousel-caption d-none d-md-block">
                        <h1 class="hero-desc"></h1>
                        <p>...</p>
...
<!--~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
    Start Statistics
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~-->
<section class="statistics-section mb-5" id="about-us">
        ...
        <div class="row justify-content-center mb-30-none">
            <div class="col-xl-6 col-lg-6 mb-30">
                <div class="statistics-left-content">
                    ...
                    <p>
                        Decascope Enterprises Limited is a general trading and incorporated company under the companies Act (Cap. 486) on 3rd September 2021. Decascope is a centre of expert professionals who are dedicated to satisfy our customers.
                    </p>
                    <div class="statistics-left-btn">
                        <a href="about.php" class="custom-btn">Know More</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 mb-30">
...
<section class="service-section two pb-120">
    ...
    <div class="container-fluid">
        ...
        <div class="row justify-content-center mb-60-none p-3">
           
            <div class="col-md-4 mb-60">
                <div class="service-item two">
                    <div class="service-icon">
                        <i class="fa fa-cog fa-4x" style="color:rgb(114, 114, 231)"></i>
                    </div>
                    <div class="service-content">
                        <h3 class="title">General Supplies</h3>
                        <p>Decascope enterprises is dedicated to providing high quality goods to our clients. We supply a wide range of products that are ideal for our customers</p>
            ...
            <div class="row justify-content-center align-items-center mb-30-none">
                ...
                <div class="col-xl-6 col-lg-6 mb-30">
                    <div class="about-content">
                        ...
                        <p class="para">We rank among the best in Kenya and East Africa at Large. Our apps get featured as best in class, & our clients love our work.</p>
                        <p>Welcome To Decascope, a software development company, helps to digitize businesses by focusing on client’s business challenges, needs, pain points and providing business-goals-oriented software solutions.</p>
                        <div class="about-btn">
                            <a href="contact.php" class="btn--base">Send Message</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row mb-30-none">
                <div class="col-xl-5 col-lg-5 mb-30">
                    <div class="contact-thumb">
                        <img src="assets/images/BlackMenOfficeVideoChat.svg" alt="contact">
                    </div>
                </div>
                                ...
                                <div class="circle">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="300px" height="300px" viewBox="0 0 300 300" enable-background="new 0 0 300 300" xml:space="preserve">
                                        ...
                                        <g>
                                            ...
                                            <text fill="#3249b3">
                                                <textPath xlink:href="#circlePathtwo">DECASCOPE ENTERPRISES LIMITED DECASCOPE ENTERPRISES LIMITED</textPath>
                                            </text>
                                        </g>
                                    </svg>
                                </div>
                            ...
                            <div class="row justify-content-center mb-30-none">
                                ...
                                <div class="col-xl-12 form-group custom-form-group mt-20">
                                    <div class="form-group custom-check-group">
                                        ...
                                        <label for="level-1">I Agree With <a href="#0" class="text--base">Terms & Conditions</a></label>
                                    </div>
