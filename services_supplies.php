...
<html lang="en">
<head>
<title>Decascope | Supplies</title>
<?php
        ...
        <div class="row justify-content-center mb-30-none">
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">Web Design</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">Digital Marketing</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">Search SEO</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">Web Development</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">IT Management</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">Data Security</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">Business Analysis</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-30">
                <div class="service-item three">
                    ...
                    <div class="service-content">
                        <h3 class="title"><a href="service-details.php">QA & Testing</a></h3>
                        <p>We rank among the best in the US, Argentina, and Ukraine. Our apps get</p>
                        <div class="service-btn">
                            <a href="service-details.php" class="custom-btn">Learn More <i class="icon-Group-2361 ml-2"></i></a>
                        </div>
        ...
        <div class="row justify-content-center">
            <div class="col-xl-12">
                <div class="agency-content text-center">
                    ...
                    <h2 class="title">Decascope is a digital agency that offers a wide scale of
